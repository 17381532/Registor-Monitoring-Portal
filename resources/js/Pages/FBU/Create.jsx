...
export default function FBUCreate() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('fbu.store'));
    };

    return (
        <AuthenticatedLayout
            header={<h2 className="font-semibold text-xl text-gray-800">Create FBU</h2>}
        >
            <Head title="Create FBU" />
                    ...
                    <div className="bg-white rounded-lg shadow p-8">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex gap-4 pt-6 border-t">
                                ...
                                >
                                    {processing ? 'Creating...' : 'Create FBU'}
                                </button>
                            </div>
                        </form>
                    </div>
